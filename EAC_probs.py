...
check_boxROMS([analysisBox], ROMS_directory, 
            depthmax=4000, save=True, out_fn='./plots/ROMS_highres.png', title='highres',
            zoom2box=True)
...
CC_probs(ROMS_directory, lr_model, analysisBox, years=[2012, 2014], out_fn='./output/EACprob_highres.csv')
